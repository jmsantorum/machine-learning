    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            if random.random() < self.epsilon:
                ...
                best_valid_actions = [action for action in self.Q[state] if self.Q[state][action] == maxQ]
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, epsilon=1, alpha=0.999)
